...
<head>
    ...
    <link rel="icon" type="" href="Photos/Company_Logo.jpg">
</head>
<body>
              ...
              <section id="navigation">
                <nav class="navbar navbar-expand-lg bg-light">
                    <div class="container-fluid">
                        <a class="navbar-brand" href="index.php"><img src="Photos/Log_2.jpg" alt="" height="80"></a>
...
<!--                                    <p>Some representative placeholder content for the first slide.</p>-->
                            ...
                            <div class="carousel-item" data-bs-interval="20000">
                                <img src="Photos/Untitled_4.png" class="d-block w-100" alt="...">
                                <div class="carousel-caption d-none d-md-block">
...
<!--                    <div class="carousel-indicators">-->
<!--                        <button type="button" data-bs-target="#carousel_indicators" data-bs-slide-to="0" class="active" aria-current="true" aria-label="Slide 1"></button>-->
<!--                        <button type="button" data-bs-target="#carousel_indicators" data-bs-slide-to="1" aria-label="Slide 2"></button>-->
<!--                        <button type="button" data-bs-target="#carousel_indicators" data-bs-slide-to="2" aria-label="Slide 3"></button>-->
...
<!--                        <span class="visually-hidden">Previous</span>-->
<!--                    </button>-->
<!--                    <button class="carousel-control-next" type="button" data-bs-target="#arousel_cators" data-bs-slide="next">-->
<!--                        <span class="carousel-control-next-icon" aria-hidden="true"></span>-->
<!--                        <span class="visually-hidden">Next</span>-->
<!--                    </button>-->
<!--                </div>-->
...
<!----------------------------------------FAQs section--------------------------------------->
                ...
                <section id="FAQs_sec">
                    <div class="container">
                        ...
                        <div class="faq">
                            <div class="quiz">
                                <h5> <i class="bi bi-chevron-double-right"> </i> How do I choose between Windows or MacOS <i class="bi bi-question-circle-fill"></i> </h5>
                                <!--SVG (Scalable Vector Graphics) is used to define graphics for the web.-->
                                <svg width="15" height="10" viewBox="0 0 42 25">
                                    <path
                                            d="M3 3L21 21L39 3"
...
<!--                </div>-->
           ...
           <div class="foot_copy">
               <p>
                   Copyright <i class="fa fa-copyright" aria-hidden="true"></i>  2023. <span>Tech</span>ware Scope Solutions. All Rights Reserved.
               </p>
